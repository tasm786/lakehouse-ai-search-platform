...
class RegistryConfig(FeastBaseModel):
    ...
    """int: The cache TTL is the amount of time registry state will be cached in memory. If this TTL is exceeded then
     ...
     expire. Users can manually refresh the cache by calling features.refresh_registry() """
...
class OpenLineageConfig(FeastBaseModel):
    ...
    Example configuration in features.yaml:
        openlineage:
            enabled: true
            transport_type: http
...
class RepoConfig(FeastBaseModel):
    """Repo config. Typically loaded from `features.yaml`"""
    ...
    def write_to_path(self, repo_path: Path):
        config_path = repo_path / "features.yaml"
