...
class FeatureStore:
    ...
    def __init__(
        ...
        Args:
            ...
            fs_yaml_file (optional): Path to the `features.yaml` file used to configure the feature store.
        ...
        # the default features.yaml location under repo_path.
    ...
    def plan(
        ...
        Examples:
            ...
            >>> from feast.features import RepoContents
